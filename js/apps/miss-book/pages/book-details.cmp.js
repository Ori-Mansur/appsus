...
export default {
    ...
    <section class="book-details">
        ...
        <img :src="book.thumbnail"/>
            ...
            <li>   <h4 >Title:</h4> <span>{{bookto.title}}</span></li>
            <li>    <h4 >Subtitle</h4> <span>:{{book.subtitle}}</span></li>
            <li>    <h4 >Authors</h4> <span>:{{book.authors}}</span></li>
            <li>   <h4 >PublishedDate</h4> <span>:{{book.publishedDate}}</span></li>
